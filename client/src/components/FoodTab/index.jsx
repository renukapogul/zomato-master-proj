    ...
    return (
        <>
            <div className="hidden lg:flex gap-14 my-8 container px-20 mx-auto">
                {allTypes.map((items)=> (
                    <Link to={`/${items.id}`}>
                        <div  className={classnames("flex items-center gap-3 pb-2 tansition duration-200 ease-in-out", {"border-b-2 border-zomato-400" : type === items.id})}>
                        <div className={
                            classnames("w-16 h-16  bg-gray-100 p-4 rounded-full" , 
